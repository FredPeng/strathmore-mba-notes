#!/usr/bin/env python3
"""Build MBA8205_Notes.html from MBA8205_Notes.md (self-contained, offline-renderable).
Toolbar title is derived from the markdown's first H1 line."""
import os, re

HERE = os.path.dirname(os.path.abspath(__file__))
SRC = os.path.join(HERE, "MBA8205_Notes.md")
DST = os.path.join(HERE, "MBA8205_Notes.html")

TEMPLATE = r"""<!DOCTYPE html>
<html lang="zh-CN">
<head>
<meta charset="UTF-8">
<title>__TITLE__ — Notes</title>
...
def main():
    ...
    title = m.group(1).strip() if m else "Course Notes"
