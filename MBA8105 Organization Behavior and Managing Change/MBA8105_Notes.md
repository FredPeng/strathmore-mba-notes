...
| 6.10 | 实施与嵌入变革 (Implementing & Embedding Change) | ✅ |
| 7 | 案例分析 (Case Studies) | ✅ |
| 8 | 阅读笔记 (Readings) | 🚧 |
| 9 | 关键术语速查 (Glossary) | ✅ |
| 10 | 期末复习 (Exam Prep) | ✅ |
...
### Session 1 概览：Nature, Context & Contemporary Realities

**课程信息：** Wednesday, 29 April 2026；5:30-8:20 p.m.；UAP Room。核心教材为 Buchanan & Huczynski (2023), 11th ed.，补充阅读为 Onyango, *Beyond the Void* (forthcoming), Ch. 1。

#### Session Roadmap

| 环节 | 时间 | 内容 |
|------|------|------|
| Welcome & Course Overview | 5:30-5:50 | Programme architecture, assessment, expectations |
| The Nature of Organisations | 5:50-7:00 | OB definition, frames of reference, orientations, globalisation |
| Refreshment Break | 7:00-7:20 | 20 minutes |
| The Triple Helix of Survival | 7:20-7:55 | OB + Change + Foresight, Anticipatory Organisation, Hot Spots |
| Contemporary Realities | 7:55-8:10 | Digital disruption, AI, STEEP-OB, Peter Principle, organisational audit |
| Reflection & Next Steps | 8:10-8:20 | Triple Helix Audit debrief, three take-homes, pre-reading |

#### Session Learning Outcomes

完成本节后，应能够：

1. 解释 OB 的性质、范围以及 unitarist、pluralist、radical 三种参考框架，并说明当代组织中的不同工作取向；
2. 分析 digital transformation、globalisation、post-pandemic models 与 AI-augmented management 对工作组织的影响；
3. 运用 **Triple Helix of Survival - OB + Change Management + Strategic Foresight** 理解组织如何应对波动；
4. 定义 Anticipatory Organisation，并使用 Hot Spots Theory 区分 Hot Spot、Cold Spot 与 Frozen Middle；
5. 使用 STEEP-Linked OB 识别行业 disruption 的早期信号，并解释 temporal advantage；
6. 对自己的组织进行 Triple Helix Audit，识别优势、薄弱螺旋与潜在失效模式。
...
- **Unitarist：** 家族企业的 owner-managers 可能把异议视为不忠。风险是压制合理申诉并制造 false harmony。
- **Pluralist：** EABL/Diageo 需要同时处理工会、股东和监管者诉求。风险是不断妥协，拖慢决策。
- **Radical：** Gig workers 通过法院挑战 algorithmic management，反映结构性权力冲突。风险是过度强调冲突而低估共享利益和务实合作。
...
**常见情境：** Instrumental orientation 常见于 gig economy 与 temporary contracts；Bureaucratic orientation 常见于 NGOs、professional services 与 family businesses；Solidaristic orientation 在 Kenya、Nigeria、India 等 collectivist cultures 中较突出。
...
| Helix | 组织层次 | 核心内容 | 缺失时的失效模式 |
|-------|----------|----------|------------------|
| **Behavioural Helix - OB** | Intelligence layer | 人如何思考、感受和行动；认知、情绪、文化、关系；engagement、trust、identity、psychological safety | **Capable but blind to human complexity**：组织可能有能力，却看不见人的复杂性 |
| **Adaptive Helix - Change Management** | Design & execution layer | 使个人与组织移动的框架与过程；ADKAR；Tell me, Show me, Guide me, Teach me | **Insightful but immobile**：看懂问题，却无法行动 |
| **Anticipatory Helix - Strategic Foresight** | Temporal layer | 构建可信未来图景；识别 weak signals；STEEP scanning；probabilistic reasoning | **Capable today, surprised tomorrow**：今天能干，明天却被变化突袭 |
...
#### The Changing Context of Organisations

| Context | 主要变化 | OB 与管理含义 |
|---------|----------|---------------|
| **Globalisation** | 劳动力、资本与知识市场跨境化；EAC integration、diaspora talent、multinational-local dynamics | 文化流畅度是战略能力；Hofstede 与 GLOBE 提醒领导效能具有文化情境性 |
| **Post-pandemic work** | Hybrid work、员工对 flexibility/purpose/wellbeing 的心理契约、知识人才议价能力变化 | 远程信任、异步协作和 change fatigue 成为核心管理问题；非正式经济暴露正式雇佣模型局限 |
| **AI-augmented management** | Generative AI、algorithmic supervision、知识层级被打破 | 引发 surveillance/dignity、identity threat 与 human meaning crisis；岗位应围绕 empathy、judgment、creative synthesis 重构 |

#### Triple Helix Audit - Diagnosing Your Organisation

对每一项按 1-10 分评分；应诚实并给出具体证据。

| Behavioural Helix | Adaptive Helix | Anticipatory Helix |
|-------------------|----------------|--------------------|
| Upward feedback 的质量与频率 | 是否有结构化 change methodology | Environmental scanning / STEEP 的质量 |
| Team discussions 中的 psychological safety | Change communication 的质量与频率 | 是否具备 strategic foresight competence |
| Leader self-awareness 与 EI | 团队的 ADKAR readiness | 过去 12 个月是否进行 scenario planning |
| Engagement、burnout、trust 数据是否进入战略决策 | 领导者是否示范新行为 | 是否有对 weak signals 采取行动的制度流程 |
| Stated values 与 observed behaviours 是否一致 | 是否存在 post-change reinforcement | 战略规划的 temporal horizon 有多长 |

**计分解释：** 35-50 = Helix Strength；20-34 = Helix Vulnerability；below 20 = Critical Gap。审计的重点不是总分，而是识别哪个 helix 最强、哪个最弱，以及缺口预示的失败方式。
...
### 1.2.1 Closing Reflection：Temporal Advantage

> 未来能够在 2030s 超越竞争者的组织，是那些建立 temporal advantage 的组织：更早感知 disruption signals、更准确解释信号，并比竞争者更快动员响应。这就是 Anticipatory Management。

**Three things to take home：**

1. **OB is not soft：** disengaged workers 每年给全球经济造成巨大损失；behaviour is the unit of organisational performance。
2. **You already have a Triple Helix：** 每个组织都在实践 OB、Change 与 Foresight，但往往没有把三者整合成有意识的系统。
3. **Volatility is the baseline：** 对 East African leaders 而言，VUCA 不是暂时危机，而是长期环境；Anticipatory Organisation 是竞争性回应。

**Session 2 pre-reading：** Buchanan & Huczynski, Chapter 6, pp. 165-201 (Personality)；*Beyond the Void*, Ch. 2 (Identity-Role Gap)；完成 Big Five self-assessment (B&H pp. 197-198)，并准备一段关于最影响自身管理行为之人格特质的反思。
...
#### A. Lewin 三步骤模型 (Lewin's Three-Step Model)

| 步骤 | 核心含义 | 管理任务 |
|------|----------|----------|
| **1. 解冻 (Unfreeze)** | 打破原有平衡，建立变革准备度和切身的变革需要。 | 挑战现状，说明旧做法为何不可持续，削弱阻力并形成心理准备。 |
| **2. 改变/移动 (Change/Move)** | 转向新的行为、角色、结构和工作方式。 | 引入新做法，通过参与、培训和支持帮助员工试验与学习。 |
| **3. 再冻结 (Refreeze)** | 将新状态稳定为组织规范、制度和文化。 | 通过领导行为、奖励、绩效制度、日常惯例、招聘和共同意义巩固新行为。 |

> **Unfreeze → Change/Move → Refreeze**

**力场逻辑 (Force-field logic)：** 组织之所以保持“准稳定平衡”，是因为推动力与阻力相互抵消。有效变革不能只增加压力，还应削弱维持现状的力量。

**AW Ltd. 案例应用：**

- **解冻不足：** Parmar 的审计证明了变革的必要性，却没有形成共同准备度，也没有削弱非正式权力、忠诚规范和身份威胁等阻力。
- **改变阶段受阻：** 新岗位定义和绩效制度虽已提出，但被动抵制、政治冲突与低参与度阻止了行为转变。
- **未能再冻结：** 实施停滞，新做法没有成为稳定的规范、制度与文化。

#### B. Kotter 八步骤模型 (Kotter's Eight-Step Model)

1. **建立紧迫感 (Create urgency)** — 让成员理解为什么必须现在改变。
2. **组建强有力的联盟 (Form a powerful coalition)** — 集结拥有正式权力、非正式影响力与可信度的支持者。
3. **建立变革愿景 (Create a vision for change)** — 描绘清晰、可信且有吸引力的未来状态。
4. **沟通变革愿景 (Communicate the vision)** — 持续、清晰并通过多种渠道传递愿景，领导者以行动示范。
5. **授权行动 (Empower action)** — 移除结构、制度、能力和权力障碍，使员工能够采取新行为。
6. **创造快速成果 (Create quick wins)** — 取得可见、可信且有意义的早期成果，以增强动力。
7. **巩固并扩展变革 (Build on the change)** — 利用早期成果推动更深层的制度与行为改变，避免过早宣布成功。
8. **使变革扎根 (Make it stick)** — 将新做法嵌入文化、制度、领导发展和日常规范。

**三个实施阶段：**

| 阶段 | Kotter 步骤 | 核心任务 |
|------|-------------|----------|
| **营造变革氛围 (Creating the climate for change)** | 1. 建立紧迫感；2. 组建强有力的联盟；3. 建立变革愿景 | 形成变革需要、领导力量和共同方向 |
| **动员并赋能组织 (Engaging and enabling the organisation)** | 4. 沟通愿景；5. 授权行动；6. 创造快速成果 | 扩大参与、移除障碍并用早期成果建立信心 |
| **实施并持续变革 (Implementing and sustaining change)** | 7. 巩固并扩展变革；8. 使变革扎根 | 深化改革并将新做法制度化、文化化 |

#### C. Lewin–Kotter 对照

| Lewin 阶段 | 对应的 Kotter 步骤 | 共同目的 |
|------------|--------------------|----------|
| **解冻 (Unfreeze)** | 1. 紧迫感；2. 强有力的联盟；3. 变革愿景；4. 沟通愿景 | 建立准备度、方向和承诺 |
| **改变 (Change/Move)** | 5. 授权行动；6. 快速成果；7. 巩固并扩展 | 在实施中促成并强化新行为 |
| **再冻结 (Refreeze)** | 8. 使变革扎根 | 将变革稳定在制度、规范和文化中 |

**关键区别：** Lewin 提供宏观的三阶段架构；Kotter 为领导者提供更细致的动员与实施步骤。

**用 Kotter 分析 AW Ltd.：** Parmar 有诊断证据和改革方向，却缺少强有力的引导联盟、广泛承诺、障碍清除和短期成果，因此变革无法植入组织文化。

**AW Ltd. 检查点 (Checkpoint)：**

- **步骤 1——建立紧迫感 (Create urgency)：** 紧迫感主要存在于创始家族层面，并没有转化为部门负责人和员工共同感受到的变革需要。
- **步骤 2——组建强有力的引导联盟 (Form a powerful guiding coalition)：** 由各部门负责人组成、拥有足够权力与影响力的联盟从未真正建立。这是整个变革中**最大的缺口**，也是后续步骤相继失败的根本原因。
- 没有引导联盟，愿景就无法得到一致沟通，障碍无法被移除，快速成果无法形成，变革也无法巩固并扎根。

> **批判性反思 (Critical reflection)：** 在你的组织中，谁负责制定变革议程？是否存在一个拥有足够权力、可信度和跨部门影响力的联盟来执行它？

#### D. McKinsey 7S 框架与 ADKAR 模型

##### D1. McKinsey 7S 组织变革模型

McKinsey 7S 是一个**组织一致性与变革诊断框架**。核心观点是：组织绩效取决于七个相互依赖的要素是否彼此对齐；改变其中一个要素，通常会影响其他要素。

| 分类 | 要素 | 含义 |
|------|------|------|
| **Hard S（硬要素）** | **Strategy（战略）** | 组织如何取得竞争优势并实现目标 |
| | **Structure（结构）** | 职责、层级、汇报关系及权力如何配置 |
| | **Systems（制度/系统）** | 日常流程、绩效管理、信息、奖励和决策机制 |
| **Soft S（软要素）** | **Shared Values（共享价值观）** | 组织共同相信什么；位于模型中心并连接其他六项 |
| | **Style（领导风格）** | 领导者如何行动、沟通、决策并树立规范 |
| | **Staff（人员）** | 组织拥有哪些人、如何配置、发展和保留人才 |
| | **Skills（技能）** | 组织与员工真正具备的核心能力 |

> **标准分类提醒：** Systems 属于 **Hard S**；Style 属于 **Soft S**；Shared Values 虽属软要素，但位于整个 7S 模型中心。

**为什么要区分 Hard S 与 Soft S？**

- **硬要素**较容易被正式设计、记录和管理，例如组织架构与绩效制度。
- **软要素**较难直接观察和改变，却会深刻影响员工是否真正采用新制度。
- 变革失败常常不是因为没有修改硬要素，而是硬要素与文化、领导风格、技能和人员配置没有同步调整。

**AW Ltd. 的 7S 诊断：**

| 7S 要素 | AW Ltd. 的失配 |
|---------|----------------|
| **Strategy** | 全球化、研发与并购战略需要现代人才能力 |
| **Structure** | 生产部门岗位重叠、汇报关系与职责不清 |
| **Systems** | HR 停留在考勤与合规，缺少透明绩效管理体系 |
| **Shared Values** | 忠诚、资历和家族信任与专业化、透明度发生冲突 |
| **Style** | Patwardhan 强势、亲力亲为；Singh 授权少且依赖非正式管理 |
| **Staff** | 老员工影响力强，HR 团队未成为积极的变革联盟 |
| **Skills** | 缺少战略 HR、跨部门协作、授权与变革实施能力 |

> **7S 结论：** Parmar 主要试图改变 Structure 与 Systems，却没有同步处理 Shared Values、Style、Staff 和 Skills，因此组织整体没有实现对齐。

##### D2. Prosci ADKAR 个体变革模型

ADKAR 是 Prosci 提出的个体变革模型，用于诊断**个人为什么没有采取或持续新的行为**。五个要素具有累积性：前一环节缺失，会阻碍后续环节。

| 阶段 | 核心问题 | 管理行动 |
|------|----------|----------|
| **A — Awareness（认知）** | 意识到变革的需要 (Awareness of the need for change) | 说明变革原因、风险和必要性 |
| **D — Desire（意愿）** | 愿意支持并参与变革 (Desire to support and participate) | 处理利益、身份、信任与个人动机 |
| **K — Knowledge（知识）** | 知道如何改变 (Knowledge of how to change) | 提供信息、培训、示范和明确流程 |
| **A — Ability（能力）** | 能够实施新技能与行为 (Ability to implement new skills and behaviours) | 提供练习、资源、辅导和障碍清除 |
| **R — Reinforcement（强化）** | 强化并维持变革成果 (Reinforcement to sustain the change) | 运用反馈、认可、奖励、问责和制度巩固 |

> **Awareness → Desire → Knowledge → Ability → Reinforcement**

**快速诊断：**

- 有 Awareness、没有 Desire：知道为什么要变，但不愿意变。
- 有 Desire、没有 Knowledge：愿意改变，但不知道怎么做。
- 有 Knowledge、没有 Ability：知道方法，但缺少技能、资源或实践条件。
- 有 Ability、没有 Reinforcement：短期能够做到，但容易回到旧行为。

**AW Ltd. 的 ADKAR 检查点：** 员工可能通过审计拥有一定 **Awareness**，但缺少 **Desire**。改革威胁非正式权力、地位和家族式身份，因此在进入 Knowledge 与 Ability 之前，变革已经受阻。

##### D3. 7S 与 ADKAR 的区别

| 框架 | 分析层面 | 主要用途 |
|------|----------|----------|
| **McKinsey 7S** | 组织层面 | 检查战略、结构、制度、文化、领导、人员和能力是否对齐 |
| **ADKAR** | 个体层面 | 诊断员工从理解变革到持续新行为的具体障碍 |

> **考试句：** 7S 揭示 AW Ltd. 的组织要素失配，而 ADKAR 解释员工为何在“知道需要改变”之后仍没有形成参与变革的意愿。

### 6.3 变革曲线、复杂性与敏捷变革 (Change Curves, Complexity & Agile Change)

#### A. 转型曲线 (Transition Curve)

组织变革中的 **Transition Curve** 借鉴 Kübler-Ross 对失落与悲伤反应的研究，用来理解员工面对变化时可能经历的心理与绩效波动。

> **震惊 → 否认 → 愤怒与责备 → 恐惧与讨价还价 → 沮丧 → 探索 → 决定 → 融入**
>
> **Shock → Denial → Anger & Blame → Fear & Bargaining → Depression → Exploration → Decision → Integration**

![组织变革转型曲线：从震惊、否认和低谷，逐渐进入试验、决定与融入](assets/transition_curve.svg)

| 阶段 | 员工可能的体验 | 管理者应对 |
|------|----------------|------------|
| **1. 震惊 (Shock)** | 意外、茫然、注意力下降，不确定变化意味着什么 | 及时说明事实、原因和已知/未知事项，避免信息真空 |
| **2. 否认 (Denial)** | 认为变化不会发生，继续依赖旧习惯或淡化影响 | 重复沟通变革必要性，用可信证据连接现实 |
| **3. 愤怒与责备 (Anger & Blame)** | 感到失去控制或遭遇不公，将责任归咎于领导、同事或变革本身 | 倾听而不防御，承认损失与情绪，澄清责任并建立心理安全 |
| **4. 恐惧与讨价还价 (Fear & Bargaining)** | 担忧地位、能力或工作安全，试图延迟、缩小或交换变革条件 | 说明具体影响，提供参与、选择、支持与现实可行的过渡安排 |
| **5. 沮丧 (Depression)** | 情绪、信心与绩效跌至低谷，旧身份松动而新方式尚未掌握 | 提供资源、辅导和可完成的小目标，避免惩罚正常的适应困难 |
| **6. 探索 (Exploration)** | 开始提出问题、探索新方法并尝试新行为 | 提供培训、试点空间、快速反馈并允许安全失败 |
| **7. 决定 (Decision)** | 对新方法形成理解与承诺，能力和信心回升 | 强化成功经验、移除障碍并扩大有效实践 |
| **8. 融入 (Integration)** | 新行为成为工作惯例、身份和文化的一部分 | 通过奖励、制度、领导示范和故事使变革扎根 |

**曲线的核心含义：** 变革的技术实施可以很快，但人的心理转型通常需要时间。绩效下降不一定意味着变革错误，也可能反映员工正处于学习与身份重构的低谷。

> **重要限制：** Kübler-Ross 原模型并不是为组织变革设计的，也不应被当作所有人都会按相同顺序经历的固定预测模型。员工可能跳过、重复或同时经历多个阶段。

#### B. 复杂适应系统与涌现式变革 (Complex Adaptive Systems & Emergent Change)

- 组织的运作方式类似由众多互动主体组成的网络；变革很少能够由高层完全控制。
- 员工、团队、领导者、客户和合作伙伴都是具有学习与适应能力的行动者 (agents)。
- **自组织 (self-organisation)** 与日常的**局部互动 (local interactions)** 会产生涌现的、非线性的结果。
- 小规模行动可能引发巨大变化，而大型正式项目也可能几乎没有效果；原因与结果并不总是成比例。
- 变革方向会随着行动者之间的反馈、关系和相互适应而演化，最终结果往往无法事先完整预测。

> **涌现式变革 (Emergent change)：** 变革不是完全按照中央蓝图展开，而是在持续互动、试验、反馈与调整中逐渐形成模式。

| 情境 | 特征 | 合适的变革方式 |
|------|------|----------------|
| **简单 (Simple/Clear)** | 因果关系明确、最佳实践已知 | 标准化、明确指令、监测执行 |
| **繁杂 (Complicated)** | 因果可分析，但需要专家判断 | 诊断、专业分析、项目规划 |
| **复杂 (Complex)** | 因果只能事后理解，参与者相互影响 | 小规模试验、感知反馈、保留有效做法 |
| **混乱 (Chaotic)** | 无法等待分析，系统失序 | 先采取行动恢复稳定，再感知和调整 |

**管理含义：** 在复杂变革中，领导者无法预先设计全部答案。其角色不是控制每个结果，而是设定方向和边界、连接行动者、创造安全试验空间、感知新模式，并扩大有效做法。过度依赖固定蓝图和线性计划，会忽视政治、情绪与意外反馈。

#### C. 敏捷变革管理 (Agile Change Management)

敏捷变革是一种**迭代式、基于冲刺周期 (sprint-based)** 的转型方式，通过小型实验、快速反馈和频繁重规划来推进大型变革。

> **确定方向 → 小规模试验 → 获取反馈 → 调整方案 → 扩大有效做法**

- 采用试点 (pilot)、原型 (prototype) 和最小可行变革 (minimum viable change)，而非一次性全面推出。
- 由跨职能团队共同创造解决方案，而不是被动接收管理层已经完成的蓝图。
- 使用短周期反馈、回顾会议 (retrospectives) 和可见成果持续学习。
- 每个冲刺周期都检验假设、交付小成果，并依据证据频繁重新规划下一步。
- 在保持战略方向清晰的同时，让实施路径根据新信息不断调整。
- 需要心理安全，否则员工会隐藏坏消息，敏捷反馈循环就会失效。
- **局限：** 高监管、高安全风险或高度相互依赖的变革仍需要明确治理、标准与长期规划。

| 传统蓝图式变革 | 敏捷变革 |
|----------------|----------|
| 先设计完整方案，再全面实施 | 先明确方向，再通过多轮试验逐步形成方案 |
| 主要由高层或专家设计 | 跨职能团队与受影响者共同创造 |
| 按里程碑检查是否执行计划 | 按短周期反馈检查是否产生价值与学习 |
| 偏差被视为需要纠正的问题 | 新信息被视为调整路径的依据 |

#### D. AW Ltd. 检查点

- Parmar 把变革视为可由审计、蓝图和时间表推动的计划项目，却低估了员工的心理转型曲线。
- **员工被快速地从震惊推入防御阶段，却没有获得足够支持跨越低谷。** 否认、责备、恐惧、被动不参与和攻击行为，反映了身份与权力受威胁后的防御反应。

**AW Ltd. 的转型曲线映射：**

| 曲线阶段 | 案例表现 |
|----------|----------|
| **震惊 (Shock)** | Parmar 以审计数据和正式改革方案挑战长期存在的家族式工作方式；员工没有经过充分的心理准备。*这是依据案例情境作出的推断。* |
| **否认 (Denial)** | 员工公开承认改革需要，却只停留在口头支持；部分人质疑审计数据或声称创始成员要求他们不要执行建议。 |
| **愤怒与责备 (Anger & Blame)** | 会议演变成争论，员工对 Parmar 进行言语攻击，并联合起来制造对变革进程的负面印象。 |
| **恐惧与讨价还价 (Fear & Bargaining)** | Singh 认为明确岗位会造成官僚主义和“各守地盘”，实际反映对自主权、团队控制和既有身份损失的担忧。 |
| **沮丧 (Depression)** | 员工逃避会议、被动不参与，项目陷入停滞；Parmar 本人也感到被排斥、无法创造价值并开始考虑离职。 |
| **探索 (Exploration)** | 几乎没有形成。员工没有共同设计试点，也缺少安全尝试新角色和制度的空间。 |
| **决定 (Decision)** | 尚未到达。组织没有形成支持新工作方式的广泛承诺。 |
| **融入 (Integration)** | 尚未到达。新岗位、绩效体系与战略 HR 角色没有成为稳定制度和文化。 |

> **关键诊断：** AW Ltd. 的问题不只是员工“抵制改变”，而是管理层把员工推入变革曲线，却没有通过参与、支持、快速成果和引导联盟帮助他们进入探索与融入阶段。

- 她可以先在一个部门进行小规模试点，共同设计岗位定义，获取反馈并创造快速成果，再逐步扩展。
- **核心教训：** 面对复杂的人际与政治系统，变革推动者应保持目标清晰，但让实施方法具有实验性和适应性。

#### E. AW Ltd.：计划式还是涌现式变革？

**问题：** AW Ltd. 是计划式变革 (planned change) 还是涌现式变革 (emergent change) 的案例？

**判断：** Parmar 实际采用的是典型的**计划式、目的论式变革**，但 AW Ltd. 本身是一个具有非正式网络、相互依赖关系和非线性反应的**复杂适应系统**。因此，案例说明的不是“计划毫无价值”，而是高度复杂的组织不能只依靠固定蓝图推进变革。

##### Parmar 采用的计划式变革

- **自上而下、审计驱动：** 通过六周诊断得出问题结论，再制定固定行动计划、承诺时间表和详细活动安排。
- **依赖权威与正确数据：** 她依靠创始成员的支持，并相信客观数据和“正确”方案足以推动员工采取行动。
- **大范围统一推出：** 她通过同时召集部门负责人和 HR 经理的会议推动整体议程，而不是先在一个愿意参与的部门开展小规模试点。
- **假定线性因果：** 诊断问题 → 提出方案 → 获得认可 → 执行改革；实际却出现联盟、抵制、信息操纵和身份防御等非线性反馈。

##### 涌现式／复杂适应型替代方案

- 从一个愿意参与的部门开始小规模试点，让早期成果逐步建立可信度。
- 把抵制视为关于系统的信息，而不只是需要克服的障碍；抵制揭示了隐藏的权力网络、身份威胁、潜在损失与信任缺口。
- 邀请员工和非正式意见领袖共同设计岗位、绩效和协作方式，让本地知识进入方案。
- 采用短周期：**试验 → 反馈 → 反思 → 调整 → 再试验**，而不是坚持一次制定的完整蓝图。
- 观察局部互动产生的新模式，保留有效做法，停止无效做法，再逐步扩展。
- 通过跨部门支持者和可信老员工形成不断成长的变革联盟，而不是只依赖创始人的正式授权。
- 保持专业化和战略 HR 的总体方向，但允许不同部门根据情境采用不同的实施路径与节奏。

##### 计划式与涌现式方法的评估

| 维度 | 计划式方法 | 涌现式方法 | AW Ltd. 的含义 |
|------|------------|------------|----------------|
| **方向** | 目标、范围和时间表清晰 | 方向明确，但路径逐步形成 | 公司需要清晰的专业化方向，但不应预设全部实施细节 |
| **控制** | 由高层和专家集中设计 | 权力与设计分布到本地团队 | 单靠 Parmar 和创始人无法控制非正式网络 |
| **参与** | 员工主要接受或执行方案 | 受影响者共同定义问题和设计方案 | 共创能够降低身份威胁并增加所有权 |
| **学习** | 偏重按计划执行和里程碑 | 偏重试验、反馈和持续调整 | 审计只是起点，抵制和试点结果也应成为数据 |
| **速度** | 初期看似较快，可统一推出 | 初期较慢，但可减少大规模失败 | Parmar 推进过快，最终导致整体停滞 |
| **适用情境** | 问题明确、因果稳定、合规要求高 | 因果不确定、政治复杂、行动者相互适应 | AW Ltd. 的文化与权力变革更接近复杂情境 |
| **主要风险** | 刚性、低参与、忽略政治与意外反馈 | 方向漂移、碎片化、进展难衡量 | 需要治理与适应性并存，而非完全放弃计划 |

##### 综合结论：混合路径

> **计划战略方向，涌现实施路径。**

AW Ltd. 最适合采用混合方法：由高层明确变革目的、原则、边界和资源；由跨职能团队通过试点、反馈与共同设计形成具体做法。这样既避免纯计划式变革的僵化，也避免纯涌现式变革可能出现的方向漂移和碎片化。

> **考试结论句：** AW Ltd. was managed as a planned change programme, but it behaved as a complex adaptive system; Parmar therefore needed a clear strategic direction combined with emergent, participative and experiment-based implementation.

> **中文表达：** AW Ltd. 被当作计划式变革项目来管理，却表现为复杂适应系统；因此 Parmar 应把清晰的战略方向与涌现式、参与式和实验式实施结合起来。

### 6.4 抵制变革 (Resistance to Change)
- **个体层面原因：**
...
### 6.5 组织发展 (Organizational Development, OD)
- **OD 干预措施：**
...
### 6.6 持续变革与学习型组织 (Continuous Change & Learning Org)
- **Senge 五项修炼：**
  - Personal mastery
  - Mental models
  - Shared vision
...
### 6.7 四种变革过程理论 (Four Process Theories of Change)

Van de Ven 与 Poole 用四种不同的**过程动力 (process motors)**解释组织变革。每种理论对“变革为什么以及如何发生”给出不同答案。

| 过程理论 | 核心逻辑 | 变革循环 | 关键问题 |
|----------|----------|----------|----------|
| **目的论 (Teleological)** | 目标驱动、有目的的改变 | 构想 → 实施 → 评估 → 修正 | 我们希望创造什么未来状态？ |
| **生命周期 (Life Cycle)** | 按预设的发展阶段演进 | 创立 → 成长 → 成熟 → 衰退/更新 | 组织目前处于哪个发展阶段？ |
| **辩证论 (Dialectical)** | 对立力量的冲突推动改变 | 正题 → 反题 → 冲突 → 合题 | 哪些利益或观念正在对抗？ |
| **进化论 (Evolutionary)** | 环境竞争与群体选择推动改变 | 变异 → 选择 → 保留 | 哪些组织形式能够存活并制度化？ |

#### A. 目的论——目标驱动循环 (Teleological Theory)

> **变革是朝着目标进行的有目的运动：**
>
> **构想 → 实施 → 评估 → 修正 → 再循环**

- 组织或群体被视为有目的、能够适应的行动者。
- 领导者与成员共同构建理想未来，而不是遵循预定阶段。
- 实施后比较实际结果与目标，再依据反馈修正目标、战略或方法。
- **管理启示：** 成功取决于目标清晰度、参与、学习和调整能力。
- **局限：** 当权力斗争或环境选择占主导时，可能高估共识与管理控制力。

**联系 AW Ltd.：** Parmar 采用目的论方法，构想专业化 HR 体系、设计干预并尝试实施；但她假定大家认同目标，低估了围绕权力、身份和地位的辩证冲突。

#### B. 生命周期理论——程序化阶段 (Life Cycle Theory)

> **变革由内在逻辑推动，并按照可预测的阶段序列展开。**
>
> **阶段 1 → 阶段 2 → 阶段 3 → 阶段 4**

- **内在逻辑 (Immanent logic)** 指发展规则包含在变化主体自身之中。
- 变革遵循内在、自然或制度规定的阶段顺序；前一阶段通常是后一阶段的前提。
- 外部事件会影响发展速度，但底层序列仍相对可预测。
- 适合分析组织创立、成长、成熟、衰退与更新。
- **局限：** 现实组织可能跳过阶段、倒退或同时沿多条路径发展。

#### C. 辩证理论——对立冲突 (Dialectical Theory)

> **变革产生于正题与反题的对抗，并形成新的合题。**
>
> **正题 (Thesis) → 反题 (Antithesis) → 对抗 → 合题 (Synthesis)**

- 组织内部存在相互对立的价值观、利益和权力联盟。
- 现有秩序或主导立场构成**正题**；反对性观念、利益或联盟构成**反题**。
- 双方对抗造成不稳定与斗争，并可能形成新的安排，即**合题**。
- 合题之后又可能成为新的正题，因此变革通过反复冲突持续发生。
- 抵制并非单纯“不理性”，也可能表达利益竞争或身份受到威胁。
- **联系 AW Ltd.：** 专业化与透明度挑战了忠诚、资历及家族式非正式权威。

#### D. 进化理论——变异、选择与保留 (Evolutionary Theory)

> **变革通过变异、竞争性选择与适应性形式保留的循环逐步累积。**
>
> **变异 → 竞争性选择 → 保留 → 新的变异**

- **变异 (Variation)：** 有意或偶然地产生多种组织实践、惯例或形式。
- **竞争性选择 (Selection)：** 环境压力与竞争偏向更适应当前条件的形式。
- **保留 (Retention)：** 成功形式被保存、复制并制度化，使变革随时间累积。
- 被保留的形式成为下一轮变异的起点，因此进化是反复循环而非单次事件。
- 分析重点通常是组织群体，而不是单个管理者的计划。
- **局限：** 可能低估人的能动性和有目的的领导行为。

#### E. 理论选择与考试应用

- 有意规划、目标导向的改变使用**目的论**。
- 按清晰阶段发展的改变使用**生命周期理论**。
- 由冲突、政治和利益竞争推动的改变使用**辩证理论**。
- 由外部竞争筛选组织形式的改变使用**进化理论**。
- 四种理论相互补充：同一次变革可能同时受到多种过程动力影响。

> **考试句：** 目的论解释了 AW Ltd. 为何计划迈向专业化 HR 体系，而辩证理论更能解释既得利益为何抵制这一转变。

### 6.8 AW Ltd.：变革管理案例 (Managing Change)

#### A. 公司 (The Company)

- **AW Ltd.** 是一家创立于 1962 年的印度家族制药企业，由创始人的第二代 Harsh Patwardhan 领导。
- 公司拥有 8,500 多名员工，业务覆盖 15 个以上国家，2012 年合并收入约 ₹25 billion。
- 公司通过研发、地域扩张及并购追求全球化，希望从传统职能型家族企业转型为专业、灵活并能够持续变革的组织。

#### B. 主角 (The Protagonist)

- **Shiela Parmar** — AW Ltd. 组织发展总经理兼变革推动者（General Manager of Organizational Development and Change Facilitator）。
- 她拥有汽车行业变革咨询经验、组织发展专业训练及 HR excellence assessment 资质，但这是她首次担任大型组织的**内部变革顾问**。
- 52 周后，因改革受阻、遭到组织排斥，她开始怀疑自己的方法，并在坚持改革与接受外部工作机会之间挣扎。

#### C. 任务授权 (The Mandate)

Parmar 的任务是让人才管理与 AW Ltd. 的增长战略保持一致，具体包括：

1. 开展 **Organizational Excellence Audit**。
2. 找出团队对齐、绩效及 HR 流程的改进领域。
3. 与 HR 副总裁协作，设计并执行整体变革战略。
4. 推动 HR 从考勤与合规职能转变为战略合作伙伴。
5. 建立透明、与企业战略挂钩的绩效管理体系，并明确生产部门的岗位职责和汇报关系。

#### D. 核心张力 (The Tension)

- **表层张力：** 公司需要专业化、透明度和角色清晰，但老员工认为正式制度会破坏“像家人一样工作”的方式，并使组织官僚化。
- **深层张力：** Parmar 依赖数据、专业知识与正式授权；组织的实际权力却来自家族信任、资历、忠诚和非正式关系网络。
- **变革者困境：** 她应继续快速推动必要改革，还是先放慢速度、建立信任与政治联盟？
- **一句话诊断：** Parmar 准确识别了正式制度的问题，却低估了变革对既有权力、身份和心理安全造成的威胁。

#### E. AW Ltd. 的变革触发因素 (Change Triggers)

| 触发类型 | 案例证据 | 变革含义 |
|----------|----------|----------|
| **内部 (Internal)** | CMD Harsh Patwardhan 的有机与非有机增长战略要求建立新的 HR 能力。 | 快速增长、地域扩张与并购要求更强的人才管理、整合能力和人员制度。 |
| **外部 (External)** | 印度制药业日益全球化；公司聘请英国 Pharmacon 提升技术知识和人员实践。 | 国际竞争与专业标准暴露了公司抱负和传统管理体系之间的差距。 |
| **渐进式 (Incremental)** | **第一阶段：** 用六周时间逐部门开展组织卓越审计与诊断。 | 变革从访谈、调查、文件审查和证据收集开始，而非立即进行全公司改造。 |
| **转型式 (Transformational)** | 从家族企业跃迁为充满活力、研发驱动的全球化公司。 | 最终目标要求从根本上改变文化、HR 角色、绩效管理、权力和工作方式。 |

> **触发链条：** 行业全球化 + 增长战略 → 新组织能力需求 → HR 卓越审计 → 商业模式与文化的预期转型。

#### F. AW Ltd. 的核心变革动态 (Core Dynamics)

| 核心动态 | 案例证据 | 变革含义 |
|----------|----------|----------|
| **政治 (Politics)** | HR 与财务副总裁之间的竞争；创始家族的非正式网络；Ram Singh 抵制明确团队角色。 | 变革威胁既有影响力、自主权和接近创始家族的渠道，使技术干预演变成政治竞争。 |
| **变革目标 (Targets)** | HR 的战略角色、生产部门岗位定义及透明绩效评估体系。 | Parmar 针对的是会重新分配信息、问责和决策权的正式结构与流程。 |
| **产生效果 (Effects)** | 言语攻击、排斥、被动不参与、逃避或争吵式会议、项目停滞及 Parmar 的失望。 | 抵制从私人担忧发展为集体防御行为，削弱了实施效果和变革推动者的投入。 |

**核心变化链条：**

> 战略与外部压力 → 正式变革目标 → 非正式权力与身份受到威胁 → 政治性抵制 → 实施停滞与变革推动者失望

**力场诊断 (Force-field diagnosis)：** AW Ltd. 拥有强大的推动力，但 Parmar 在没有先削弱非正式权力、身份威胁和低信任等阻力的情况下继续增加变革压力。

**与四种过程理论的联系：**

- **目的论：** Patwardhan 与 Parmar 追求建立专业化、研发驱动的全球公司。
- **辩证论：** 专业化与根深蒂固的家族权威及老员工利益发生冲突。
- **生命周期：** AW Ltd. 试图从传统家族企业阶段迈向专业成熟阶段。
- **进化论：** 全球竞争与监管更有利于拥有强大技术和人才能力的制药企业。

> **考试句：** AW Ltd. 的变革由全球化和 Patwardhan 的增长战略触发，以 HR 和生产体系为目标，却在正式改革与非正式权力网络及身份性抵制发生碰撞时陷入停滞。

#### G. 为什么变革启动过程失败？——课堂投影片总结

| 失败点 | 对应模型 | AW Ltd. 的表现 |
|--------|----------|----------------|
| **忽视内部人士建议 (Ignored insider counsel)** | Lewin：解冻不足 | Parmar 没有采纳 HR 副总裁的警告：先适应群体规范，再识别支持者与反对者。 |
| **没有引导联盟 (No guiding coalition)** | Kotter：步骤 2 | 她拥有创始成员的认可，却没有建立由部门负责人组成的广泛联盟。 |
| **低估非正式权力 (Underestimated informal power)** | 复杂适应系统 | 她忽略了家族式非正式影响渠道；这些关系比正式组织图更能决定实际行动。 |
| **自上而下强推 (Top-down imposition)** | ADKAR：Desire 缺口 | 她展示审计结论后要求行动，没有与员工共同定义问题和设计解决方案。 |
| **威胁既有人员 (Threat to incumbents)** | 7S：Style、Staff、Shared Values | 角色清晰直接威胁 Singh 和老员工；他们的地位与价值建立在模糊性、资历和非正式控制之上。 |
| **变革节奏失配 (Mismatched change pace)** | 变革曲线／节奏管理 | 她按照“正确数据”的速度推进，而不是按照组织信任与准备度的速度推进。 |

> **课堂综合：** 她诊断了结构，却没有诊断政治；她掌握了变革内容，却没有掌握变革过程。

#### H. Parmar 的关注点——她做得好吗？

**她主要关注：**

- **技术与诊断卓越：** 通过访谈、调查和文件审查进行严谨的 HR 卓越审计。
- **结构性修复：** 明确岗位角色，建立透明且与战略挂钩的绩效评估体系。
- **变革内容 (“what”)：** 把注意力集中在审计结论和行动计划本身。
- **速度与数据正确性：** 更重视数据和方案是否正确，而不是利益相关者是否准备好。

**评价：**

- **第一阶段——诊断：强。** 证据可信、方法充分、审计真实，不只是个人意见。
- **第二阶段——变革过程：弱。** 内容正确、过程错误；她诊断了结构，却没有诊断政治。
- 她忽略了 HR 副总裁基于经验提出的明确建议：先建立联盟，再推进制度改革。

> **课堂判词：** Parmar 是一位技术上胜任的变革推动者，却没有充分承担政治性变革领导者的角色；总体只能算局部成功。

#### I. 每个变革过程都必须管理的“软领域”

| 软领域 | 管理含义 |
|--------|----------|
| **透明之前先建立信任 (Trust before transparency)** | 在高度信任和忠诚导向的文化中，应先赢得可信度，再公开暴露组织弱点。 |
| **非正式网络与政治 (Informal networks & politics)** | 绘制真正影响决策的人际网络；家族关系与任职年限可能比正式职称更重要。 |
| **沟通的顺序与节奏 (Sequencing & pace of communication)** | 逐步建立切身的变革需要；突然且数据密集的正面对抗容易引发防御，而不是认同。 |
| **身份与地位威胁 (Identity & status threats)** | 角色清晰对长期任职员工可能像降职；必须处理情绪与身份损失，而不仅是结构调整。 |
| **联盟建设 (Coalition-building)** | 在召开对抗性、数据驱动的大型会议前，先在各部门培养可信的支持者。 |
| **正确解读沉默 (Reading silence correctly)** | 被动不参与就是一种抵制；没有公开反对并不等于同意。 |

#### J. 综合反思问题 (Bringing It Together)

1. 在你的组织中，谁制定变革议程？还应该让哪些人参与？
2. 是否存在一个拥有足够权力、可信度和跨部门影响力的引导联盟来执行变革？
3. 你如何衡量组织中某项变革倡议是否成功？现有证据是什么？
4. 如果你是第 52 周的 Parmar，你会留下来重设战略，还是选择离开？为什么？
5. 本节哪个模型最可能改变 AW Ltd. 的结局——Lewin、Kotter、7S、ADKAR、变革曲线，还是复杂适应系统？为什么？

> **我的判断：** Kotter 的“引导联盟”最关键，因为它可以把创始人的意图转化为跨部门的正式与非正式执行力量；但联盟能否形成，仍取决于信任、身份和政治网络是否得到妥善处理。

#### K. Parmar 的诊断与改革方案

| 发现的问题 | 案例表现 | 改革方案 |
|------------|----------|----------|
| HR 缺乏战略作用 | 主要负责考勤和法定合规 | 将 HR 提升为战略伙伴，建立与战略挂钩的绩效管理体系 |
| 部门政治严重 | HR 与财务副总裁争功，各部门争取创始家族认可 | 加强跨部门协作与团队对齐 |
| 生产部门角色模糊 | Ram Singh 授权不足、指令含糊、工作重复 | 明确岗位职责、汇报关系和角色边界 |
| 非正式权力强 | 老员工依靠资历、家族信任和私人网络影响决策 | 以透明、正式的人员流程取代个人化管理 |

#### L. 变革为何失败

1. **过度相信数据与技术理性：** Parmar 认为审计证据足以形成支持，但数据只能证明变革的必要性，不能自动创造变革意愿。
2. **忽视非正式权力：** 绩效透明化和岗位清晰化会削弱老员工的控制权，因此改革被视为权力重新分配，而不是单纯的流程改善。
3. **没有先建立信任与联盟：** 她没有充分采纳 HR 副总裁关于适应组织规范、识别支持者和反对者、逐步建立可信度的建议。
4. **高层支持模糊：** 创始成员口头鼓励她，却没有持续、公开地为改革背书；员工甚至以创始成员的名义拒绝执行建议。
5. **缺少参与式设计：** 部门负责人和员工主要被要求接受审计结论，没有成为问题定义和方案设计的共同所有者。
6. **速度与组织准备度不匹配：** 她选择“重大问题需要重大措施”，直接挑战深层文化和既有利益，触发被动抵抗、会议回避、争论、人身攻击与排斥。
7. **内部变革者角色转换失败：** 她沿用外部顾问的“诊断—建议—执行”逻辑，却没有充分经营内部顾问所需的长期关系、政治敏感度和可信度。

#### M. 理论框架映射

| 理论 | 案例诊断 |
|------|----------|
| **Lewin** | Parmar 直接进入 change，没有充分 unfreeze；旧文化、利益与心理依附尚未松动。 |
| **Kotter** | 缺少有影响力的 guiding coalition、共享愿景、持续沟通和 short-term wins。 |
| **ADKAR** | 员工可能有 Awareness，却缺乏 Desire；部分人也不相信自己会从变化中获益。 |
| **Schein Culture** | 她改变的是制度与流程等 artifacts，但没有处理“忠诚、资历、家族信任优先”等深层假设。 |
| **French & Raven** | Parmar 主要依赖 expert power；老员工拥有 referent、informational 和接近家族形成的非正式权力。 |
| **Morgan: Political System** | 组织不是价值中立的机器，而是围绕稀缺认可、地位和控制权形成的利益联盟。 |
| **Organisational Justice** | 改革者认为透明制度更公平，但员工可能把改革过程体验为缺乏参与、威胁身份的程序不公。 |
| **Psychological Contract** | 老员工默认“忠诚与资历会换来信任和自主权”；新制度打破了这一隐性契约。 |

#### N. Parmar 更合适的行动方案

1. 与 CEO / 创始家族明确变革授权、不可协商事项和公开支持方式。
2. 绘制利益相关者与权力网络，识别支持者、中间者、关键阻力者及其潜在损失。
3. 分别与 HR、生产部门和关键老员工沟通，把抵制视为诊断信息，而非单纯的不合作。
4. 由员工共同设计角色与绩效制度，保留家族式协作的优点，同时减少职责重叠。
5. 选择阻力较低、结果可见的部门开展试点，以 quick wins 建立可信度。
6. 分阶段扩大改革，并同时衡量制度执行、员工信任、参与度和行为变化。

#### O. 考试答题结构 (Exam Answer Structure)

题目示例：**Using Kotter, organisational culture and power theory, explain why Parmar's change initiative at AW Ltd. encountered resistance.**

1. **先点明核心矛盾：** 失败不源于诊断错误，而源于过程设计没有适应家族企业的文化和权力结构。
2. **Kotter：** 没有形成强有力的 guiding coalition，也缺少共享愿景、持续沟通和短期成果。
3. **Schein：** 正式制度改革挑战了忠诚、资历与家族信任等深层文化假设。
4. **Power：** Parmar 的 expert power 无法压过老员工的 referent、informational 和非正式关系权力。
5. **结论：** 有效变革必须同时管理制度、意义、利益、关系和员工的心理过渡。

#### P. 考试/讨论句 (Exam / Discussion Sentence)

> AW Ltd. 表明：当变革推动者只把组织视为正式制度，而员工却把变革体验为权力、身份和安全感的重新分配时，即使技术上正确的方案也可能失败。

#### Q. 管理启示

- 正确的方案不等于可执行的方案。
- 变革抵制往往保护的是地位、控制权、关系和安全感，而不只是旧流程。
- 高层口头支持不够；需要公开、一致且持续的行动支持。
- 家族企业专业化不能简单消灭非正式网络，而要理解并逐步重构它。
- **先建立信任和联盟，再推进透明度与问责制度。**

---

### 6.9 Leading Change：课堂路线图与核心框架

> **课堂主题：** Leading change is not only about installing new systems. It is about helping people understand, believe in and move toward a different future.

#### A. Tonight's Roadmap

**Part 1: Setting the Direction**

1. Roadmap
2. Change Leadership vs. Change Management
3. Kotter: Creating Urgency and Building a Coalition
4. Developing a Vision for Change
5. Communicating Change
6. Discussion 1: Syndicate Activity

**Break: 20 Minutes**

**Part 2: Leading People Through Change**

1. Resistance to Change
2. Stakeholder Mapping
3. Co-creation and Participation
4. Change Fatigue
5. Narrative Leadership
6. Discussion 2 and Closing

> 课堂逻辑：Part 1 关注方向和动员：为什么要变、谁来带领、愿景是什么、如何沟通。Part 2 转向人的层面：抵制、利益相关者、参与、疲劳与叙事领导。

#### B. Change Management vs. Change Leadership：两个不同但相互依赖的学科

| 维度 | Change Management | Change Leadership |
|------|-------------------|-------------------|
| 核心任务 | **Getting the mechanics right** | **Making people want to move** |
| 关注点 | 计划、里程碑、预算、风险、流程、培训、合规、采纳率、ROI | 愿景、能量、信任、承诺、文化、心态、联盟、抵制、持续动能 |
| Kotter 观点 | Management produces **order and consistency** | Leadership produces **change**, often dramatically |
| 典型例子 | ERP system implementation; ISO certification rollout | Organisational transformation; post-merger integration |

**Change Management 的典型活动：**
- Project planning, milestones and budgets
- Risk assessment and mitigation
- Process design and documentation
- Training, rollout and compliance tracking
- Measuring adoption and ROI

**Change Leadership 的典型活动：**
- Setting and communicating a compelling vision
- Building energy, trust and commitment
- Influencing culture and mindset shifts
- Navigating resistance and building coalitions
- Sustaining momentum through uncertainty

> **关键句：** Change management helps ensure that the change is structured, resourced, tracked and delivered. Change leadership helps ensure that people understand it, believe in it and commit energy to making it real.

#### C. Kotter Recall：Urgency, Coalition and Early Wins

**1. Create Urgency**

- Show the gap between current reality and what is at stake.
- Use data and stories: speak to both the head and the heart.
- Kotter argues that a strong majority of management must be convinced that change is necessary.
- In the East African context, urgency must be grounded in shared values, purpose and collective responsibility, not only competitive threat.

> **课堂提醒：** Urgency 不是制造恐慌，而是让人看见“不变”的代价和“现在行动”的意义。

**2. Build the Guiding Coalition**

- Bring together power, credibility, leadership skill and urgency.
- Look beyond formal hierarchy; informal influence matters.
- Span silos and include selected sceptics who can sharpen thinking and build legitimacy.
- East African / collective lens: Who are the elders? Whose blessing carries weight? Who can unlock trust?

> **连接 AW Ltd.：** Parmar 最大的问题之一就是没有建立足够强的 guiding coalition。她有 expert power 和创始人授权，但缺少跨部门、可信任、有非正式影响力的联盟。

**3. Generate Early Wins**

- Make wins visible, unambiguous and clearly linked to the change effort.
- Use early wins to build momentum and credibility for deeper change.
- Recognize and reward contributors to signal the new culture in action.
- Without early wins, cynicism and resistance can harden.

> **考试用法：** 用 Kotter 分析失败变革时，常问三个问题：紧迫感是否共享？联盟是否足够强？是否出现了可信的 early wins？

#### D. What Makes a Vision Work, and What Kills It

**Effective Vision：Kotter 的六个特征**

| 特征 | 含义 |
|------|------|
| **Imaginable** | Creates a clear picture of the future |
| **Feasible** | Contains realistic and achievable goals |
...
| **Communicable** | Can be explained in five minutes and still create a response |

**Vision Killers**

- **Too vague:** "We will be the best."
- **Too long:** a 250-word paragraph nobody reads.
- **Too safe:** no real trade-offs, tension or sacrifice.
- **Top-down only:** the leader's vision, not our vision.
- **Disconnected from daily work:** people cannot see what it changes on Monday morning.
- **One-and-done:** announced in January, forgotten by March.

> **关键句：** A good vision does not just sound inspiring. It helps people make choices. If the vision cannot guide priorities, trade-offs, resource allocation and everyday behaviour, it is probably only a slogan.

#### E. Communicating Change：Channels, Frequency, Consistency and Authenticity

> **课堂主题：** Communication is not an announcement; it is the repeated creation of shared meaning.

**1. Channels：渠道选择**

- Match channel to audience, not convenience.
- Use face-to-face communication for emotional content; use digital channels for logistics.
- Use all three levels: town halls, team briefings and one-to-ones.
- East African context: communal gatherings carry symbolic and relational weight that digital communication cannot fully replace.

> **管理含义：** 变革沟通不是把信息“发出去”，而是让不同群体在合适的场景中理解、提问、表达担忧并形成共同意义。

**2. Frequency：频率**

- Kotter argues that most leaders under-communicate the change vision by a factor of 10.
- Silence is often interpreted as bad news; fill the silence before rumours fill it.
- Repeat the vision in every relevant forum.
- Predictable cadence reduces anxiety: for example, a weekly update and a monthly town hall.

> **关键句：** In change, repetition is not redundancy; it is reassurance.

**3. Consistency：一致性**

- Keep the core message stable across leaders, departments and channels.
- Ensure the same message is carried by senior leaders, middle managers and frontline supervisors.
- Align words, decisions, resource allocation and leadership behaviour.
- If different leaders give different explanations, employees will trust the version that best fits their fears.
- If finance, operations and HR each tell a different story, trust in the change effort weakens quickly.
- Consistency does not mean using the exact same script; it means preserving the same logic, priorities and promises.

> **连接组织公平：** Consistent communication supports procedural and interactional justice. People may accept difficult change more readily when the explanation is stable, respectful and transparent.

**4. Authenticity：真实可信**

- People can smell spin; honest humility about uncertainty builds trust.
- Acknowledge uncertainty, trade-offs and losses instead of pretending everything is positive.
- Acknowledge what you do not yet know, and commit clearly to what you will do next.
- Communicate with empathy: explain what is known, what is not yet known and when people will hear more.
- Leaders must embody the message; inconsistency between speech and behaviour destroys credibility.
- Do not sell change against people's lived reality; connect the message to what they actually experience.
- Authentic communication invites questions and dissent rather than treating resistance as disloyalty.

> **考试用法：** Poor change communication increases anxiety, rumours, cynicism and resistance. Effective communication uses the right channel, repeats the message, stays consistent and feels credible because leaders act in line with what they say.

#### F. Discussion 1：Communication Plan Peer Critique

> **Group discussion — Part 1 consolidation before the break.**

**Syndicate task:**

- Each participant drafts or brings a one-page communication plan for a significant change initiative in their organisation.
- The plan is shared with the syndicate for structured peer critique.

**1. Apply the four communication lenses (8 minutes)**

As a syndicate, apply tonight's four criteria to one member's plan:

- **Channels:** Are the channels matched to the audience and emotional weight of the message?
- **Frequency:** Is the message repeated often enough, with a predictable cadence?
- **Consistency:** Do senior leaders, middle managers and frontline supervisors tell the same change story?
- **Authenticity:** Does the message feel honest, grounded and connected to people's lived reality?
...
- If time allows, rotate to another member's plan.

**2. Kotter test (5 minutes)**

Use Kotter's early change logic to test the communication plan:

- Does the plan create genuine urgency?
- Can the vision be stated in one sentence?
- Would the plan reach informal influencers and sceptics, or only the already-convinced?
- What is the single most important insight the syndicate should share?

> **课堂输出：** Elect a spokesperson. Each syndicate shares one key insight before the break.

#### G. Resistance to Change：Sources, Signals and Responses

> **课堂主题：** Resistance is not simply opposition. It is often information about perceived loss, fear, distrust or previous wounds from failed change.

**Individual Sources of Resistance**

- **Loss of status, security or identity:** People may fear that the new system reduces their importance, job safety or sense of who they are at work.
- **Lack of trust in leadership intent:** Employees may suspect that the stated reason for change is not the real reason.
...
- Involve people early, especially those directly affected.
- Do not argue resistance away; acknowledge it.
...
- **Structural inertia:** Existing processes, routines, reporting lines and approval systems resist deviation from the current way of working.
- **Sunk cost in current systems and skills:** Organisations may resist change because they have already invested heavily in existing platforms, capabilities, training and professional identities.
- **Competing priorities and change fatigue:** Multiple simultaneous initiatives can make even necessary change feel like overload.
- **Board or governance-level resistance to risk:** Senior governance bodies may delay or dilute change when they see uncertainty, reputational exposure or strategic risk.

**Leadership Response at Organisational Level**

- Address structural levers: incentives, metrics and governance.
- Align systems so the new behaviour is rewarded rather than quietly punished.
- Sequence changes to reduce overload.
- Remove process barriers that make the old way easier than the new way.

> **关键句：** Organisational resistance is often designed into the system. Leaders must change the conditions around behaviour, not only ask people to behave differently.

#### H. Stakeholder Management：Power-Interest Grid

> **课堂主题：** Stakeholder management means mapping, diagnosing and engaging the people who can support, resist, amplify or derail the change.

**Power-Interest Grid**

| Stakeholder Category | Power / Interest | Priority | Engagement Strategy |
|----------------------|------------------|----------|---------------------|
| **Manage Closely** | High power / high interest | **Top priority** | Treat as key partners. Involve them in design, build personal relationships, engage and consult frequently. |
| **Keep Satisfied** | High power / low interest | **Moderate priority** | Involve and consult them on areas of interest. They can derail the change, so monitor their interest and concerns. |
| **Keep Informed** | Low power / high interest | **Moderate priority** | Treat as potential advocates and early adopters. Give them a voice; they can spread the message. |
| **Monitor** | Low power / low interest | **Low priority** | Use minimum effort but keep them informed enough. Watch for shifts in their interest or power. |

**Leadership Use**

- Do not communicate to all stakeholders in the same way.
- Prioritise relationship-building with high-power stakeholders before moments of conflict.
- Use high-interest, low-power stakeholders as listening posts and message carriers.
- Re-map stakeholders as the change evolves; power and interest can shift quickly.

> **连接 Kotter：** Stakeholder mapping helps identify the guiding coalition, informal influencers, sceptics and potential early adopters.

#### I. Co-creation and Participation：From "Change Happens to You" to "Change Happens with You"

> **课堂主题：** Participation reduces resistance because people are less likely to reject a change they helped shape. The opposite is the **NIH effect (Not Invented Here)**: people resist ideas imposed from outside their group, even when the ideas are technically sound.

**The Participation Continuum**

| Participation Level | Message to Stakeholders | Expected Resistance |
|---------------------|-------------------------|--------------------|
| **Inform** | "We decided. Here is what will happen." | **High** |
| **Consult** | "We are deciding. Your input may shape it." | **Medium-high** |
| **Involve** | "Help us design the how." | **Medium** |
| **Collaborate** | "We design it together. Shared ownership." | **Low** |
| **Co-create** | "You lead the design; we resource and support it." | **Very low** |

**Leadership Use**

- Match participation level to the decision space that is genuinely open.
- Do not pretend to co-create if the major decisions are already fixed.
- Use consultation and involvement to surface resistance early, before it hardens.
- Use collaboration and co-creation when local knowledge, identity and ownership are critical to implementation.
...
#### K. Discussion 2：Your Change Initiative, Stakeholders, Resistance and Change Story

> **Group discussion — Part 2 application.**

**Syndicate task:** Apply the second half of the session to your own change initiative.

1. **Map your top three stakeholders on the power-interest grid.**
   - What is their current position?
   - What drives it?
   - What is your engagement strategy for each?

2. **Identify your most significant resistance source.**
   - Is it individual, group or organisational?
   - Apply the leadership response from tonight.
   - What would you do differently?

3. **Draft a 90-second change story.**
   - **Burning Platform:** Why must we change now?
   - **Promised Land:** What better future are we moving toward?
   - **Bridge:** What concrete first steps happen next?
   - **Personal Stake:** Why do you personally care?

> **课堂输出：** One person delivers the 90-second story to the full group.

#### L. 小结：Leading Change 的考试句
...
### 6.10 实施与嵌入变革：从计划到持久转型 (Implementing & Embedding Change)

#### A. Session 13 路线图与学习目标

**主题：** Making Change Stick — implementation, embedding and reinforcement。

本节关注的不是如何宣布变革，而是如何让变革在项目结束、发起人离开或员工更替后仍然持续。学习目标包括：

- 评估决定实施成败的技术、政治、文化与人员因素；
- 通过 anchoring、routinisation 与 institutionalisation 建立嵌入条件；
- 运用强化理论、习惯形成与问责系统，让新行为持续；
- 使用 Prosci Change Triangle 以及 adoption、utilisation、proficiency 指标评估变革成效；
- 整合全课程，形成个人 Change Leadership Development Profile。

#### B. Opening Provocation：六个月后，变革还活着吗？

> You launched the change. Six months later—did it survive?

课堂投影片援引 Gartner (2025)：**73% 的 HR leaders 表示其组织存在显著 change fatigue**，原因之一是持续、重叠、却没有完全嵌入的变革项目。

**The uncomfortable truth：** 变革往往不是在启动时失败，而是在几个月后遇到日常惯例、组织政治、员工疲劳以及项目结束后无人负责时逐渐逆转。因此，成功上线不等于持久转型；变革必须拥有持续的责任人、强化机制、日常整合与项目结束后的衡量体系。

#### C. 从计划到实践：两条实施路径 (Two Roads In)

| 路径 | 做法 | 优势 | 风险／局限 |
|------|------|------|-----------|
| **Phased Implementation（分阶段实施）** | 按阶段、职能或地点逐步推出 | 风险较低；第一阶段的经验可以改进下一阶段 | 速度较慢；阶段之间的紧迫感与动能可能减弱 |
| **Big-Bang Implementation（一次性全面实施）** | 整个组织在同一天切换 | 动能高；迫使组织一次性作出完整承诺 | 风险高；正式上线后纠正方向的空间很小 |

**判断原则：** 两种路径没有绝对优劣。选择取决于组织的准备程度、风险承受能力、相互依赖程度以及维持变革动能的能力。

#### D. 决定实施成败的四项因素

| 因素 | 核心检查问题 | 失败表现 |
|------|--------------|----------|
| **Technical（技术）** | 系统、流程、资源与基础设施是否真正支持新的工作方式？ | 新流程无法运行、工具不兼容、资源不足 |
| **Political（政治）** | 权力持有者、联盟及竞争利益是否支持变革？ | 表面同意、暗中拖延或悄悄切断资源 |
| **Cultural（文化）** | 变革是否符合现有价值观、规范与隐含假设？ | 新做法被视为“不适合我们”、旧规范重新占上风 |
| **Human（人员）** | 员工是否具备技能、情绪容量与心理安全？ | 不会做、不敢做、疲惫或退回旧行为 |

实施失败通常不是单一的项目管理问题，而是以上四项条件没有与实施路径对齐。

#### E. Embedding Change：让新方式成为唯一方式

Kotter 的第八步——**anchor the change in the culture**——经常在工作真正完成之前被放弃。Embedding 区分了两种变革：一种能够超越项目发起人与项目团队继续存在；另一种则在项目团队解散后悄悄逆转。

##### 1. Anchoring（锚定）

- 把新行为与可见成果明确联系起来；
- 把新做法连接到组织原有价值观和成功故事；
- 让人们看见“我们之所以取得成果，是因为采用了这种新方式”。

##### 2. Routinisation（常规化）

- 重复新行为，直到它变得自动化；
- 将其嵌入日常工作流程、会议节奏与标准作业程序；
- 不再把它当作临时或特殊项目。

##### 3. Institutionalisation（制度化）

- 将变革写入组织结构、政策、岗位说明、KPI 与接班安排；
- 使其能够承受员工流动；
- 让制度超越最初推动变革的个人。

> **Embedding progression:** Anchoring 让变革与意义和成果相连；Routinisation 把它变成习惯；Institutionalisation 把它写入组织系统。

#### F. 如何衡量变革是否真正落地

##### 1. Prosci Change Triangle (PCT)

Prosci 的研究认为，成功变革要求三个相互连接的支柱围绕经历变革的人协同运作；任何一个支柱薄弱，都会削弱另外两个：

- **Leadership / Sponsorship（领导与赞助）：** 提供方向、合法性、可见承诺与组织支持；
- **Project Management（项目管理）：** 设计并交付技术方案、范围、进度与资源；
- **Change Management（变革管理）：** 准备、装备并支持人们采用新的工作方式。

**People（人）**位于三角形中心，因为组织成果最终依赖个人改变自己的工作方式。

##### 2. Evidence-Based Change Metrics

- **Adoption（采纳度）：** 开始采用新工作方式的目标人群比例；
- **Utilisation（使用度）：** 持续、一致使用新方式且没有退回旧习惯的人群比例；
- **Proficiency（熟练度）：** 人们使用新方式的质量——衡量 competence，而不只是 compliance。

**Change ROI = Adoption × Utilisation × Proficiency**

由于三个指标是乘数关系，任何一项明显偏弱都可能使整体结果崩塌。只检查培训完成率或系统上线日期是不够的；真正的成功必须同时看到采纳、持续使用与熟练表现。

#### G. Resilient Organisations & Change Fatigue

##### The Cost of Change Fatigue

课堂投影片指出：**73% 的 HR leaders 表示其组织存在显著 change fatigue**。Change fatigue 是员工面对多个相互重叠、且彼此之间没有恢复时间的变革项目时产生的累积性疲惫（Gartner, 2025）。

疲惫不一定阻止变革正式启动，却会阻止变革真正扎根。精疲力竭的员工可能在上线当天表面服从，却在数周内悄悄恢复旧做法。

##### Building Organisational Resilience

- **有意识地控制变革节奏：** 合理安排各项计划的先后顺序，并在项目之间保留恢复时间；
- **建立适应能力：** 分散领导与决策权，避免依赖单一关键人物或单点故障；
- **嵌入反馈循环：** 尽早发现压力与疲劳，防止它们发展成沉默抵制；
- **保护心理安全：** 让员工能够提出担忧，而不是选择沉默和脱离投入。

组织韧性不是无限承受变革的能力，而是在不耗尽执行者的前提下，有节奏地吸收、学习并维持变革的能力。

#### H. Sustaining Change：强化理论与习惯形成

##### 1. Reinforcement Theory（强化理论）

Skinner 的核心观点是：**受到奖励的行为会被重复；被忽视或惩罚的行为会逐渐消失。** 如果组织没有公开认可和持续强化新的工作方式，旧行为就会悄悄回归。

这意味着认可、激励、反馈、绩效指标与后果必须支持目标行为。组织一方面宣布新要求、另一方面继续奖励旧做法，会从制度上破坏变革。

##### 2. Habit Formation（习惯形成）

新行为通过不断重复的习惯循环变得持久：

**Cue（提示）→ Routine（惯例）→ Reward（奖励）**

- **Cue：** 稳定触发新行为的信号；
- **Routine：** 实际执行的新行为或工作方式；
- **Reward：** 强化重复行为的成果、认可或反馈。

当这个循环在稳定情境中不断重复，新行为需要的意识努力逐渐降低，最终成为日常工作方式。

##### 3. Accountability Systems（问责系统）

- **绩效指标与考核标准：** 重写指标，使其衡量并奖励新行为，而不是继续衡量旧行为；
- **Visible sponsorship（可见的领导支持）：** 领导者公开、持续地示范新行为，而不只是通过备忘录宣布；
- **认可与后果机制：** 表彰早期采用者，同时让退回旧做法产生真实成本；
- **定期检查与仪表板：** 在正式上线日期过去很久以后，仍让变革进展保持可见。

问责系统使强化机制制度化，并使领导者所说的、员工所看到的、组织所衡量的，以及实际奖惩的行为保持一致。

#### I. Benefits Realisation：把变革转化为可衡量的价值

Benefits realisation plan 通过明确每项预期收益、责任人以及衡量方法，使变革价值变得清晰。成功必须被证明，而不是在项目结束后被假定。

##### 1. Define & Baseline（定义与建立基线）
...
##### 2. Track & Measure（追踪与衡量）

- 按固定节奏将收益指标与目标比较；
- 尽早发现实际表现与目标之间的差距；
- 在变革仍有动能时采取纠正措施。

##### 3. Realise & Sustain（实现与维持）
...
> **关键原则：** 项目按时完成不等于变革成功。只有所有权、持续衡量与收益交付在项目结束后继续存在，变革才真正创造了价值。

#### J. Evaluating Change：Change Management 与 Project Management 的交汇

##### 在三个层次评估变革

1. **Process（过程）：** 变革是否按设计实施——是否按时、按正确顺序，并覆盖预定人群？
2. **Outcome（结果）：** 行为是否真正改变？人们是否持续并熟练地使用新方式？
3. **Impact（影响）：** 变革是否实现了原本预期、也是获得资金支持的业务成果？

##### Where Project Management Meets Change Management

- **Project Management** 负责交付技术方案，确保按时、在预算内并符合范围；
- **Change Management** 确保人们采纳并实际使用该方案；
- **Return on investment** 只有在两者交汇时才能实现。

> A solution that nobody uses delivers zero value, however well it was built. 无论方案建得多好，如果没有人使用，它创造的价值都是零。

#### K. Visioneering：把愿景工程化

**Visioneering = Explanation + Conviction + Action + Determination + Completion**

- **Explanation：** 清楚说明改变什么以及为什么改变；
- **Conviction：** 建立对愿景的真实信念；
- **Action：** 把愿景转化为具体任务和行为；
- **Determination：** 在阻力、疲劳与挫折中持续推进；
- **Completion：** 坚持到新方式完全实施并嵌入。

愿景给出目的地，Visioneering 则确保组织真正抵达。这个 destination 应当提供四样东西：
...
#### N. Closing Summary：From the Individual to the Institution

十三次课程从个人开始，以作为整体的组织结束——组织应当能够规划、领导、实施并嵌入持久的变革。

- 实施成败取决于 technical、political、cultural 与 human readiness，而不只是计划本身；
- 变革通过 anchoring、routinisation 与 institutionalisation 扎根，而不是依靠一次上线活动；
- Reinforcement、habit 与 accountability systems 把表面服从转化为持久行为；
- Resilient organisations 有意识地控制变革节奏，并保护员工免受累积性疲劳。

##### What Comes Next

- **Study Week：** 20-25 July 2026 — self-directed revision；复习所有 focus sessions；
...
- **背景：** M-PESA 于 2007 年推出；到 2020 年，其年度交易额相当于 Kenya GDP 的 50% 以上，成为发展中世界最成功的移动金融服务平台之一。
- **Behavioural Helix：** 产品为承受 financial scarcity 和高 cognitive load 的用户降低 cognitive friction；每一步交易只需要很少的 working memory。这首先是 behavioural insight，而不只是技术设计。
- **Adaptive Helix：** Safaricom 从 telecommunications 转向 financial services，在监管不确定性下管理巨大组织复杂性；这相当于 national-scale change management。
- **Anticipatory Helix：** 领导层把 mobile money 视为 strategic infrastructure，而不是普通产品功能，并提前判断 real-time behavioural transaction data 将比 historical actuarial tables 更有价值。
...
1. Safaricom 在 2005-06 年发现了哪些竞争者忽视的 STEEP signals？
2. 哪一个 helix 对 M-PESA 成功最关键？为什么？
3. M-PESA 的下一前沿是什么？哪一个 helix 最脆弱？
...
| Phased Implementation | 分阶段实施 | 按职能、地点或阶段逐步推出变革，以降低风险并吸收经验 |
| Big-Bang Implementation | 一次性全面实施 | 整个组织在同一时间切换，动能高但风险与纠错成本也高 |
| Anchoring | 锚定 | 将新行为与可见成果、组织价值观和成功故事联系起来 |
| Routinisation | 常规化 | 通过重复把新行为嵌入日常流程、会议节奏和标准作业程序 |
| Institutionalisation | 制度化 | 将变革写入政策、结构、岗位职责、KPI 与接班机制 |
| Adoption / Utilisation / Proficiency | 采纳／使用／熟练度 | 分别衡量是否采用、实际使用程度以及使用质量 |
| Prosci Change Triangle (PCT) | Prosci 变革三角 | Leadership/Sponsorship、Project Management 与 Change Management 围绕 People 协同运作 |
| Visioneering | 愿景工程化 | 通过解释、信念、行动、决心与完成，把愿景变成持久实践 |
| Reinforcement Theory | 强化理论 | 受到奖励的行为更可能重复；被忽视或惩罚的行为会逐渐消失 |
| Habit Loop | 习惯循环 | Cue → Routine → Reward，通过稳定触发与奖励使新行为自动化 |
| Accountability Systems | 问责系统 | 通过绩效指标、领导示范、奖惩、检查与仪表板持续强化新行为 |
| Benefits Realisation | 收益实现 | 定义收益与基线、持续追踪衡量，并在项目结束后维持成果 |
| Change Fatigue | 变革疲劳 | 多个重叠变革且缺少恢复时间造成的累积性疲惫，常导致表面服从和行为倒退 |
| Organisational Resilience | 组织韧性 | 通过节奏管理、分布式能力、反馈循环与心理安全吸收并持续变革 |
| Process / Outcome / Impact | 过程／结果／影响 | 分别评估实施质量、行为改变以及最终业务价值 |
...
- 变革：Lewin、Kotter、ADKAR、7S、resistance、learning organisation、phased vs big-bang implementation、technical/political/cultural/human factors、anchoring/routinisation/institutionalisation。
...
13. Compare phased and big-bang implementation, then explain how technical, political, cultural and human factors shape the outcome.
14. Explain why successful launch does not guarantee sustainable change. Use anchoring, routinisation and institutionalisation in your answer.
15. Explain how reinforcement theory, habit formation and benefits realisation prevent employees and organisations from reverting to old practices.
16. Explain how change fatigue undermines implementation and evaluate four practices for building organisational resilience.
17. Evaluate a change initiative at process, outcome and impact levels, explaining where project management meets change management.
...
### 10.4 讲师最新考试重点 (Latest Lecturer Exam Focus)

- 理解**领导人们经历变革需要什么**，特别关注本节的 anchoring、embedding 与 sustaining change；
- 重点准备**情境题 (scenario questions)**，分析 OB 对具体情境的 implications；
- 不要只定义理论，要说明 **OB concepts 如何在案例事实中表现 (manifest)**；
- 准备应用 **Emotional Intelligence** 分析领导、自我管理、关系与变革反应；
- 掌握 **Power → Change → Conflict** 的连接，并分析 organisational politics；
- Conflict 无法完全避免，管理者需要识别其来源并进行建设性管理；
- 始终准备 **Plan B**：运用 Murphy's Law 思维，预判失败点并提出 contingency。

#### 情境题推荐答题步骤

1. 找出情境中的核心组织或行为问题；
2. 选择最相关的 OB 概念或框架；
3. 引用具体案例事实，说明理论如何在情境中表现；
4. 解释对个人、团队、领导与组织绩效的影响；
5. 提出可执行建议，同时处理风险、权力、政治、冲突，并给出备用方案。
